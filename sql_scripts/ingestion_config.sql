...
((SELECT IFNULL(MAX(ingestion_config_id), 0) + 1 FROM `dw-metadata-utilities.metadata_utilities.ingestion_config`),'REQUEST_PAYLOAD','https://api.coincap.io/v2/assets/bitcoin/history/','ID','DATE','INCR','h1',NULL,'COINCAP',2,'COINCAP_BITCOIN_HISTORY','COINCAP-DATA-HUB','EXTERNAL_COINCAP_DATA','EXTERNAL_COINCAP_BITCOIN_HISTORY','JSON',NULL,'COINCAP API 2.0', NULL, NULL, FALSE, TRUE, 'dev-coincap-data', 'input/coincap_history','archive/coincap_history','gzip','ADMIN',CURRENT_DATETIME,'ADMIN',CURRENT_DATETIME),
((SELECT IFNULL(MAX(ingestion_config_id), 0) + 1 FROM `dw-metadata-utilities.metadata_utilities.ingestion_config`),'REQUEST','https://api.coincap.io/v2/exchanges/','ID',NULL,'FULL',NULL,NULL,'COINCAP',3,'COINCAP_EXCHANGES','COINCAP-DATA-HUB','EXTERNAL_COINCAP_DATA','EXTERNAL_COINCAP_EXCHANGES','JSON',NULL,'COINCAP API 2.0', NULL, NULL, FALSE, TRUE, 'dev-coincap-data', 'input/coincap_exchanges/','archive/coincap_exchanges','gzip','ADMIN',CURRENT_DATETIME,'ADMIN',CURRENT_DATETIME),
((SELECT IFNULL(MAX(ingestion_config_id), 0) + 1 FROM `dw-metadata-utilities.metadata_utilities.ingestion_config`),'REQUEST','https://api.coincap.io/v2/rates/','ID',NULL,'FULL',NULL,NULL,'COINCAP',5,'COINCAP_RATES','COINCAP-DATA-HUB','EXTERNAL_COINCAP_DATA','EXTERNAL_COINCAP_RATES','JSON',NULL,'COINCAP API 2.0', NULL, NULL, FALSE, TRUE, 'dev-coincap-data', 'input/coincap_rates/','archive/coincap_rates','gzip','ADMIN',CURRENT_DATETIME,'ADMIN',CURRENT_DATETIME),
((SELECT IFNULL(MAX(ingestion_config_id), 0) + 1 FROM `dw-metadata-utilities.metadata_utilities.ingestion_config`),'REQUEST','https://api.coincap.io/v2/assets/','ID',NULL,'FULL',NULL,NULL,'COINCAP',1,'COINCAP_ASSET','COINCAP-DATA-HUB','EXTERNAL_COINCAP_DATA','EXTERNAL_COINCAP_ASSETS','JSON',NULL,'COINCAP API 2.0', NULL, NULL, FALSE, TRUE, 'dev-coincap-data', 'input/coincap_assets/','archive/coincap_assets','gzip','ADMIN',CURRENT_DATETIME,'ADMIN',CURRENT_DATETIME);
